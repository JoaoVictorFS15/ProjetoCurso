...
namespace ProjetoCurso.Controllers
{
    public class SellersController : Controller
    {
        ...
        public SellersController(ProjetoCursoContext context)
        {
            _context = context;
        }
        ...
        {
            var projetoCursoContext = _context.Seller.Include(s => s.Department);
            return View(await projetoCursoContext.ToListAsync());
        }
        ...
        {
            ViewData["DepartmentId"] = new SelectList(_context.Department, "Id", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,BirthDate,BaseSalary,DepartmentId")] Seller seller)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Department, "Id", "Nome", seller.DepartmentId);
            return View(seller);
        }
